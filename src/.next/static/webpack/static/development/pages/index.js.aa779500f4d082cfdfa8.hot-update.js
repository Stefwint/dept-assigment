...
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./styles */ "./components/Form/Fields/styles.js");
...
var Email = function Email(_ref) {
  ...
  return __jsx(_styles__WEBPACK_IMPORTED_MODULE_5__["Flex"], {
    mb: [15, 30],
    mt: [15, 0],
    px: [0, 25],
    flexDirection: "column",
    width: width
  }, label && __jsx(_styles__WEBPACK_IMPORTED_MODULE_5__["Flex"], {
    alignItems: "center"
  }, __jsx(_styles__WEBPACK_IMPORTED_MODULE_5__["FormLabel"], {
    htmlFor: id
  }, isRequired ? label + '*' : label)), __jsx(_styles__WEBPACK_IMPORTED_MODULE_6__["default"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    id: id,
    name: name,
    ref: register({
      required: 'Required',
  ...
  }, props)), (errors === null || errors === void 0 ? void 0 : errors.email) && __jsx(_styles__WEBPACK_IMPORTED_MODULE_6__["SError"], null, errorMessage.required), errorMessage && touched && value && !isValid && __jsx(_styles__WEBPACK_IMPORTED_MODULE_6__["SError"], null, errorMessage.email));
};
...
//# sourceMappingURL=index.js.aa779500f4d082cfdfa8.hot-update.js.map